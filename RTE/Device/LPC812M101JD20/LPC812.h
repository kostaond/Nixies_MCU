...
typedef struct {
  ...
  union {                                          /* offset: 0x100 */
    __IO uint32_t SCTCAP[5];                         /**< SCT capture register of capture channel, array offset: 0x100, array step: 0x4 */
    __IO uint32_t SCTMATCH[5];                       /**< SCT match value register of match channels, array offset: 0x100, array step: 0x4 */
  };
       uint8_t RESERVED_2[236];
  union {                                          /* offset: 0x200 */
    __IO uint32_t SCTCAPCTRL[5];                     /**< SCT capture control register, array offset: 0x200, array step: 0x4 */
    __IO uint32_t SCTMATCHREL[5];                    /**< SCT match reload value register, array offset: 0x200, array step: 0x4 */
  };
...
#define SCT_SCTCAPCTRL_COUNT                     (5U)
...
#define SCT_SCTMATCHREL_COUNT                    (5U)

/*! @name EVENT_STATE - SCT event state register 0 */
/*! @{ */
#define SCT_EVENT_STATE_STATEMSK0_MASK           (0x1U)
#define SCT_EVENT_STATE_STATEMSK0_SHIFT          (0U)
#define SCT_EVENT_STATE_STATEMSK0(x)             (((uint32_t)(((uint32_t)(x)) << SCT_EVENT_STATE_STATEMSK0_SHIFT)) & SCT_EVENT_STATE_STATEMSK0_MASK)
#define SCT_EVENT_STATE_STATEMSK1_MASK           (0x2U)
#define SCT_EVENT_STATE_STATEMSK1_SHIFT          (1U)
#define SCT_EVENT_STATE_STATEMSK1(x)             (((uint32_t)(((uint32_t)(x)) << SCT_EVENT_STATE_STATEMSK1_SHIFT)) & SCT_EVENT_STATE_STATEMSK1_MASK)
/*! @} */

/* The count of SCT_EVENT_STATE */
#define SCT_EVENT_STATE_COUNT                    (6U)
...
#define SCT_EVENT_CTRL_COUNT                     (6U)
