 ...
 * @version 1.2
 * @date 2017-06-08
 * @brief Device specific configuration file for LPC812 (header file)
 *
...
#ifndef _SYSTEM_LPC812_H_
#define _SYSTEM_LPC812_H_                        /**< Symbol preventing repeated inclusion */
